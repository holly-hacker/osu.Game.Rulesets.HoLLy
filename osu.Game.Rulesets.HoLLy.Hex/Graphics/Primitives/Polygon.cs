...
namespace osu.Game.Rulesets.HoLLy.Hex.Graphics.Primitives
{
    public struct Polygon
    {
        ...
        public Polygon(Vector2 center, float radius, int sides) : this(center, radius, radius, sides) { }
        public Polygon(Vector2 center, Vector2 radius, int sides) : this(center, radius.X, radius.Y, sides) { }

        public Polygon(Vector2 center, float radiusX, float radiusY, int sides)
        {
            if (sides < 3)
            ...
            var shared = CreateVector2(center, radiusX, radiusY, 0);
            Vector2 prev = CreateVector2(center, radiusX, radiusY, angleInterval);
